// ======================================================================
// ZumoBot_Lib_IR_Copy.v generated from TopDesign.cysch
// 07/20/2016 at 14:36
...
module top ;
    ...
    Timer_v2_70_3 Timer_RL (
        .reset(Net_12),
        .interrupt(Net_2909),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(Net_2267),
        .capture_out(Net_3430),
        .tc(Net_3431),
        .clock(Net_10));
    ...
    Timer_v2_70_6 Timer_RR (
        .reset(Net_2602),
        .interrupt(Net_3270),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(Net_2789),
        .capture_out(Net_3435),
        .tc(Net_3436),
        .clock(Net_2600));
    ...
    Timer_v2_70_7 Timer_LL (
        .reset(Net_3156),
        .interrupt(Net_3177),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(Net_3160),
        .capture_out(Net_3440),
        .tc(Net_3441),
        .clock(Net_3154));
    ...
    Timer_v2_70_8 Timer_LR (
        .reset(Net_3165),
        .interrupt(Net_3205),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(Net_3169),
        .capture_out(Net_3445),
        .tc(Net_3446),
        .clock(Net_3163));
