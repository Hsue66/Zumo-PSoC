...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x48000BECu)

/* UDB_0_1_0_CONFIG Address: CYDEV_UCFG_B1_P4_U1_BASE Size (bytes): 128 */
#define BS_UDB_0_1_0_CONFIG_VAL ((const uint8 CYFAR *)0x48000BF4u)

/* IOPINS0_0 Address: CYREG_PRT0_DM0 Size (bytes): 8 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000C74u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000CA4u)
