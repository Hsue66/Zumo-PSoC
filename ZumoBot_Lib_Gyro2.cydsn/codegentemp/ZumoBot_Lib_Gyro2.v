// ======================================================================
// ZumoBot_Lib_Gyro2.v generated from TopDesign.cysch
// 07/11/2016 at 13:28
...
module I2C_v3_50_4 (
	...
	cy_clock_v1_0
		#(.id("ffbf5631-d6bd-4faf-a9ed-5a1f02f7142d/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
    ...
    Timer_v2_70_3 GyroTimer (
        .reset(Net_12),
        .interrupt(Net_3413),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_3417),
        .tc(Net_3418),
        .clock(Net_10));
    defparam GyroTimer.CaptureCount = 2;
    defparam GyroTimer.CaptureCounterEnabled = 0;
    defparam GyroTimer.DeviceFamily = "PSoC5";
    defparam GyroTimer.InterruptOnCapture = 0;
    defparam GyroTimer.InterruptOnTC = 0;
    defparam GyroTimer.Resolution = 16;
    defparam GyroTimer.SiliconRevision = "0";
	...
	cy_psoc3_pins_v1_10
		#(.id("7dede1e4-4948-49c1-a9c8-b2ccd5ac1a75"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ba6a84c7-ed85-43b5-bb8b-2ae11f2c92cf"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
