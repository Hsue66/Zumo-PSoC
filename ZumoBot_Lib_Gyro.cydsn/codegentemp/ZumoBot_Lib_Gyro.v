// ======================================================================
// ZumoBot_Lib_Gyro.v generated from TopDesign.cysch
// 07/11/2016 at 11:14
...
module top ;
    ...
    Timer_v2_70_3 Timer_RR (
        .reset(Net_2602),
        .interrupt(Net_3270),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(Net_2789),
        .capture_out(Net_3444),
        .tc(Net_3445),
        .clock(Net_2600));
    ...
    Timer_v2_70_4 Timer_LL (
        .reset(Net_3156),
        .interrupt(Net_3177),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(Net_3160),
        .capture_out(Net_3449),
        .tc(Net_3450),
        .clock(Net_3154));
    ...
    Timer_v2_70_5 Timer_LR (
        .reset(Net_3165),
        .interrupt(Net_3205),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(Net_3169),
        .capture_out(Net_3454),
        .tc(Net_3455),
        .clock(Net_3163));
    ...
    Timer_v2_70_6 Timer_RL (
        .reset(Net_12),
        .interrupt(Net_2909),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(Net_2267),
        .capture_out(Net_3439),
        .tc(Net_3440),
        .clock(Net_10));
